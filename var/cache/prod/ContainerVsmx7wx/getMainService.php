...
// Returns the public 'AppBundle\Controller\Main' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\AppBundle\\Controller\\Main.php';

return $this->services['AppBundle\Controller\Main'] = new \AppBundle\Controller\Main();
