...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\FormType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\FormType']) ? $this->services['AppBundle\Form\FormType'] : $this->services['AppBundle\Form\FormType'] = new \AppBundle\Form\FormType()) && false ?: '_'};
}, 'AppBundle\\Form\\UserType' => function () {
    return ${($_ = isset($this->services['app.form.registration']) ? $this->services['app.form.registration'] : $this->services['app.form.registration'] = new \AppBundle\Form\UserType()) && false ?: '_'};
