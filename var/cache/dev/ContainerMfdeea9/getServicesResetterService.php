...
return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
    ...
    if (isset($this->services['fos_rest.validator'])) {
        yield 'debug.validator' => ${($_ = isset($this->services['fos_rest.validator']) ? $this->services['fos_rest.validator'] : null) && false ?: '_'};
    }
    ...
    return 0 + (int) (isset($this->services['profiler'])) + (int) (isset($this->services['fos_rest.validator'])) + (int) (isset($this->services['debug.stopwatch'])) + (int) (isset($this->services['security.token_storage'])) + (int) (isset($this->services['form.type.entity']));
