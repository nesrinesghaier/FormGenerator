...
return $this->services['argument_resolver.service'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Controller\\FormController:setViewHandler' => function () {
...
}, 'AppBundle\\Controller\\FormController::setViewHandler' => function () {
    return ${($_ = isset($this->services['service_locator.r15f9hk']) ? $this->services['service_locator.r15f9hk'] : $this->load('getServiceLocator_R15f9hkService.php')) && false ?: '_'};
})));
