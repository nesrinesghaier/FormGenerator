    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/user')) {
            ...
            if ('/user/test' === $pathinfo) {
                $ret = array (  '_controller' => 'AppBundle\\Controller\\UserController::testAction',  '_route' => 'app_user_test',);
            ...
            // user_test
            if ('/user/test' === $pathinfo) {
                $ret = array (  '_controller' => 'AppBundle\\Controller\\UserController::testAction',  '_route' => 'user_test',);
                if (!in_array($requestMethod, array('POST'))) {
                    $allow = array_merge($allow, array('POST'));
                    goto not_user_test;
                }
        ...
        elseif (0 === strpos($pathinfo, '/form')) {
            // form_list
            if ('/form' === $pathinfo) {
                $ret = array (  '_controller' => 'AppBundle\\Controller\\FormController::listAction',  '_route' => 'form_list',);
                if (!in_array($canonicalMethod, array('GET'))) {
                    $allow = array_merge($allow, array('GET'));
                    goto not_form_list;
                }
            ...
            if (0 === strpos($pathinfo, '/form/create')) {
                // form_create
                if ('/form/create' === $pathinfo) {
                    $ret = array (  '_controller' => 'AppBundle\\Controller\\FormController::createAction',  '_route' => 'form_create',);
                    if (!in_array($requestMethod, array('POST'))) {
                        $allow = array_merge($allow, array('POST'));
                        goto not_form_create;
                    }
                ...
                // create
                if ('/form/create' === $pathinfo) {
                    $ret = array (  '_controller' => 'AppBundle\\Controller\\FormController:createAction',  '_format' => NULL,  '_route' => 'create',);
                    if (!in_array($requestMethod, array('POST'))) {
                        $allow = array_merge($allow, array('POST'));
                        goto not_create;
                    }
            ...
            // list
            if ('/form' === $pathinfo) {
                $ret = array (  '_controller' => 'AppBundle\\Controller\\FormController:listAction',  '_format' => NULL,  '_route' => 'list',);
                if (!in_array($canonicalMethod, array('GET'))) {
                    $allow = array_merge($allow, array('GET'));
                    goto not_list;
                }
